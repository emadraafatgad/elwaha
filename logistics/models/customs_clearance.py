...
class CustomsClearance(models.Model):
    ...
    pol = fields.Many2one('container.port',ondelete='restrict',string='POL')
    arrival_port = fields.Many2one('container.port',ondelete='restrict',string='POD')
    bank= fields.Many2one('res.partner',ondelete='restrict', domain=[('partner_type','=','bank')])

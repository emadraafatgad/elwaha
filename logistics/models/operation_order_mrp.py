...
class OperationOrderMRPPlan(models.Model):
    ...
    container_type = fields.Many2one('container.type', track_visibility="onchange", readonly=True,)
    ...
    forwarder = fields.Many2one('res.partner',  track_visibility="onchange",readonly=True, domain=[('partner_type', '=', 'forwarder')])
    shipping_line = fields.Many2one('res.partner', track_visibility="onchange", readonly=True, string="Shipping Line",
    ...
    exit_port = fields.Many2one('container.port', track_visibility="onchange", string='Containers Withdrawl Port', readonly=True,)
    shipment_port = fields.Many2one('container.port', track_visibility="onchange",string= 'POL', readonly=True, )
    arrival_port = fields.Many2one('container.port', track_visibility="onchange",string= 'POD', readonly=True,)
    loading_place = fields.Many2one('loading.place', track_visibility="onchange", readonly=True,)
    ...
    inspection_company1 = fields.Many2one('res.partner', track_visibility="onchange",  readonly=True, domain=[('partner_type', '=', 'inspection_company')])
    inspection_company2 = fields.Many2one('res.partner',  track_visibility="onchange", readonly=True, domain=[('partner_type', '=', 'inspection_company')])
